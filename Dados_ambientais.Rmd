...
Intervalo temporal: 2000-2014, principalmente
...
Link: <https://marine.copernicus.eu/access-data> (será preciso criar uma conta)
...
Intervalo temporal: Salinidade e temperatura estão disponíveis em 1955-1964, 1965-1974, 1975-1984, 1985-1994, 1995-2004, 2005-2014, 2015-2022 e 3 normais climatológicas para períodos de 30 anos: 1971-2000, 1981-2010, e 1991-2020. Phosphate, silicate, e nitrate estão apenas para 1965-2022. Oxygen, Apparent Oxygen Utilization, e Percent Oxygen Saturation estão disponíveis para 1965-2022 e 1971-2000.
...
Os dados podem ser encontrados indo, a partir do link, em "Data", onde então poderemos escolher entre cada uma das variáveis. Todas parecem estar disponíveis nas resoluções de 1° e 5°, e algumas estão na resolução de 0.25°. Podemos escolher para cada uma o período climatológico e a quantidade de medidas nesse período, entre anual, trimestral ou mensal, assim como o formato do arquivo entre .csv, .nc, entre outros. Todos os dados estarão disponíveis em diferentes profundidades, especificadas na documentação para cada variável.
...
Para fazer o download, basta clicar na variável, escolher o formato do arquivo (estarei usando diretamente o NetCDF, pois é mais simples e direto que pegar o CSV e converter depois para um raster), a resolução (estarei usando 1° mas poderia usar 0.25°, apenas para deixar o arquivo um pouco mais leve para a análise inicial) e o período climatológico desejado (estarei usando o período de 1991-2020). Então, temos que escolher entre "Annual", "Seasonal" ou "Monthly" (não entendo qual a diferença, mas penso que é basicamente ou usar a média de todo o ano, ou a média daquele trimestre, ou a média daquele mês, onde todos os arquivos terão o mesmo tamanho). Estarei usando o Annual. Por fim, basta clicar em qualquer um dos servidores para fazer download do arquivo, onde estou usando o HTTPServer.
