...
do RStudio como a pasta "PIBITI" com os arquivos e imagens usadas, em 
"Files" -> "..." -> Escolher pasta "PIBITI", e então ir no símbolo 
de configurações -> "Set as Working Directory"
...
latitude como +90 e -90 irá dar um erro nos rasters, na minha
experiência)
...
Resolução espacial: 1°, 5°, 10°, 20° (mesmo aqueles com resolução Lat/Lon parecem ser de 1°)

Link: <https://www.iccat.int/en/accesingdb.html>

-----

O Manual ICCAT pode ser encontrado em <https://www.iccat.int/en/iccatmanual.html>
...
identificar a área conforme o código da região - todos esses pontos parecem ter latitude e longitude iguais a 0
